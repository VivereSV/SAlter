        ...
        twitch.getUser("teamdawnbreakers")
            .then(data => {
                if(data.stream === null) {
                    ...
                    if(!wasUp) {
                      wasUp = true;
                      message.channel.send("@here I-it's not like I w-want you to go watch " + sTitle + " at https://www.twitch.tv/teamdawnbreakers anyways you b-baka <:GWagnwNatsukiBlush:407618674707660811>";
                    }
                }
            })
        .catch(error => {
